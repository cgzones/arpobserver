...
void process_arp(struct pkt *p)
{
	...
	log_notice("%s: Ignoring ARP packet. Packet dump: %s", p->ifc->name, base64_encode_packet(p));
}
...
void process_ns(struct pkt *p)
{
	...
	log_debug("%s: Ignoring IPv6 NS packet. Packet dump: %s", p->ifc->name, base64_encode_packet(p));
}
...
void process_na(struct pkt *p)
{
	...
	log_debug("%s: Ignoring IPv6 NA packet. Packet dump: %s", p->ifc->name, base64_encode_packet(p));
}
...
void process_ra(struct pkt *p)
{
	...
	log_debug("%s: Ignoring IPv6 RA packet. Packet dump: %s", p->ifc->name, base64_encode_packet(p));
}
...
void process_rs(struct pkt *p)
{
	...
	log_debug("%s: Ignoring IPv6 RS packet. Packet dump: %s", p->ifc->name, base64_encode_packet(p));
}
